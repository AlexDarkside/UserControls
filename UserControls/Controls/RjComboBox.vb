...
Public Class RJComboBox
    ...
    Private cmbList As ComboBox = Nothing
    ...
    Public Sub New()
        ...
        cmbList.Font = New Font("Times New Roman", 12)
        ...
        AddHandler btnIcon.Paint, New EventHandler(AddressOf Icon_Paint)
    ...
    Private Sub ComboBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles Me.OnSelectedIndexChanged
        ''  If OnSelectedIndexChanged IsNot Nothing Then OnSelectedIndexChanged.Invoke(sender, e)
    ...
    Private Sub Icon_Paint(ByVal sender As Object, ByVal e As PaintEventArgs)
        ...
        Using path As GraphicsPath = New GraphicsPath()
            ...
            Using pen As Pen = New Pen(_iconColor, 2)
                graph.SmoothingMode = SmoothingMode.AntiAlias
                path.AddLine(Integer.Parse(rectIcon.X), Integer.Parse(rectIcon.Y), Integer.Parse(rectIcon.X + (iconWidht / 2)), Integer.Parse(rectIcon.Bottom))
                path.AddLine(Integer.Parse(rectIcon.X + (iconWidht / 2)), Integer.Parse(rectIcon.Bottom), Integer.Parse(rectIcon.Right), Integer.Parse(rectIcon.Y))
